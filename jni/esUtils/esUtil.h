...
int ESUTIL_API esGenCube ( float scale, GLfloat **vertices, GLfloat **normals, 
                           GLfloat **texCoords, GLushort **indices, GLfloat **tangents );
...
//
float ESUTIL_API esDeterminant(ESMatrix *matrix);
	
//
/// \ calculate the inverse of a 4x4 matrix
//
void ESUTIL_API esInverseMatrix(ESMatrix *result, ESMatrix *matrix);
